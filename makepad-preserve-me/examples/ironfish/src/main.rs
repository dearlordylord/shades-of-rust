...
live_design!{
    ...
    FishDropDown = <DropDown> {
        ...
        label: {
            ...
            // },
            text_style: {font_size: (FONT_SIZE_H2), font: {path: d"../blog/shades-of-rust/makepad/IBMPlexSans-SemiBold.ttf"}},
    ...
    FishSlider = <Slider> {
        ...
        label: "CutOff1"
        label_text: {text_style: {font_size: (FONT_SIZE_H2), font: {path: d"../blog/shades-of-rust/makepad/IBMPlexSans-SemiBold.ttf"}}, color: (COLOR_TEXT_H2)}
        text_input: {
    ...
    FishHeader = <Solid> {
        ...
        label = <Label> {
            label: {
                text_style: {font_size: (FONT_SIZE_H1), font: {path: d"../blog/shades-of-rust/makepad/IBMPlexSans-SemiBold.ttf"}},
                color: (COLOR_TEXT_H1)
            }
            text: "replace me!"
        }
    ...
    App = {{App}} {
        ...
        ui: {
            ...
            <Frame> {
                ...
                <Image> {
                    image: d"../blog/shades-of-rust/makepad/tinrs.png",
