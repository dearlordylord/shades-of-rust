// taken from https://github.com/kas-gui/kas/blob/master/examples/async-event.rs with modifications
...
fn main() -> kas::shell::Result<()> {
    ...
    // TODO DefaultShell as per https://github.com/kas-gui/kas/commit/219fc5f8d621c0a25cd9782fb1c46207cfc47e51
    ...
    let colour_copy = colour.clone();

    thread::spawn(move || generate_colors(proxy, update_id, colour_copy));
...
// TODO rename ::Proxy as per https://github.com/kas-gui/kas/commit/a1ff949c0013be4627f07eb3cc904c34686d8afb
